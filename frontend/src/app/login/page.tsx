...
import { Sparkles, ArrowRight, Sun, Eye, EyeOff } from "lucide-react";
      ...
      >
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-6">
          ...
          <motion.button
            ...
            whileHover={{ y: -3, scale: 1.01, boxShadow: "0px 10px 20px rgba(249, 115, 22, 0.3)" }}
            whileTap={{ scale: 0.97 }}
            type="submit"
            className="w-full bg-gradient-to-r from-orange-500 to-rose-500 text-white font-bold py-4 rounded-xl mt-2 flex items-center justify-center gap-2 group"
          >
          ...
          <div className="grid grid-cols-2 gap-4">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="button"
              className="flex items-center justify-center gap-2 py-3 bg-white/40 hover:bg-white/60 border border-white/50 rounded-xl transition-colors font-medium text-sm text-slate-700 shadow-sm"
            >
